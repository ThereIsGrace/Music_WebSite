...
export function Write({board}) {
  console.log(board, '보드 값');
    ...
    <>
      <Container>
        <HeaderSection>
          ...
          <input type="text" name="title" id="title-section" placeholder="제목을 입력해주세요" onChange={e => setTitle(e.target.value)} defaultValue={board? board.title : null}></input> 
        </HeaderSection>
